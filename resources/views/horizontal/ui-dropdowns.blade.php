                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-lg-3 m-t-30">
                            ...
                            <div class="row m-t-20">
                                <div class="col-md-6">
                                    ...
                                    <div class="">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-purple dropdown-toggle waves-effect waves-light" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                Dropdown
                                            </button>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="btn-group dropup">
                                        <button type="button" class="btn btn-warning dropdown-toggle waves-effect waves-light" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            Dropup
                                        </button>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="#">Action</a>
                                    ...
                                    <div class="btn-group dropup">
                                        <button type="button" class="btn btn-pink dropdown-toggle waves-effect waves-light" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            Dropup
                                        </button>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="#">Action</a>
