...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="card-box">
                            ...
                            <form class="form-horizontal">
                                <div class="form-group row">
                                    <label for="range_01" class="col-sm-2 control-label">Default<span class="font-13 display-block text-muted clearfix">Start without params</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" id="range_01">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="range_02" class="col-sm-2 control-label">Min-Max<span class=" font-13 display-block text-muted f-s-12 clearfix">Set min value, max value and start point</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" id="range_02">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="range_03" class="col-sm-2 control-label">Prefix<span class="font-13 display-block text-muted f-s-12 clearfix">showing grid and adding prefix "$"</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" id="range_03">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="range_04" class="col-sm-2 control-label">Range<span class="display-block font-13 text-muted f-s-12 clearfix">Set up range with negative values</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" id="range_04">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="range_05" class="col-sm-2 control-label">Step<span class="display-block font-13 text-muted f-s-12 clearfix">Using step 250</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" id="range_05">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="range_06" class="col-sm-2 control-label">Custom Values<span class="display-block font-13 text-muted f-s-12 clearfix">Using any strings as values</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" id="range_06">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="range_07" class="col-sm-2 control-label"><b>Prettify Numbers</b><span class="display-block font-13 text-muted f-s-12 clearfix">Prettify enabled. Much better!</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" id="range_07">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="range_08" class="col-sm-2 control-label"><b>Disabled</b><span class="display-block font-13 text-muted f-s-12 clearfix">Lock slider by using disable option</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" id="range_08">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="range_09" class="col-sm-2 control-label"><b>Extra Example</b><span class="display-block font-13 text-muted f-s-12 clearfix">Whant to show that max number is not the biggest one?</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" id="range_09">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="range_10" class="col-sm-2 control-label"><b>Use decorate_both option</b><span class="display-block font-13 text-muted f-s-12 clearfix">Use decorate_both option</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" id="range_10">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="range_11" class="col-sm-2 control-label"><b>Postfixes</b><span class="display-block font-13 text-muted f-s-12 clearfix">Using postfixes</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" id="range_11">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="range_12" class="col-sm-2 control-label"><b>Hide</b><span class="display-block font-13 text-muted f-s-12 clearfix">Or hide any part you wish</span></label>
                                    <div class="col-sm-10">
        ...
        <script src="{{asset('assets/pages/jquery.ui-sliders.js')}}"></script>
